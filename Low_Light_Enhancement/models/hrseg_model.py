...
def create_hrnet():
    ...
    args['cfg'] = './models/hrseg_lib/pascal_ctx/seg_hrnet_w48_cls59_480x480_sgd_lr4e-3_wd1e-4_bs_16_epoch200.yaml'
    args['opt'] = []
    ...
    pretrained_dict = torch.load('./models/hrseg_lib/hrnet_w48_pascal_context_cls59_480x480.pth')
